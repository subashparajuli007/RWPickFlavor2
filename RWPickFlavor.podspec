...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Subash Parajuli" => "subashparajuli91@gmail.com" }
  # Or just: spec.author    = "Subash Parajuli"
  # spec.authors            = { "Subash Parajuli" => "subashparajuli91@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Subash Parajuli"
